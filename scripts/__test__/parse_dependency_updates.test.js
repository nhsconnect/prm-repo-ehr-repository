import { extractDependencyUpdatesFromList, isUpdate, fromString, getAllUpdates } from "../parse_dependency_updates";
...
describe('parse_dependency_updates.js', () => {
    ...
    describe('isUpdate', () => {
       it('should return true if the string contains an update', () => {
          expect(isUpdate('/Users/someone/git/prm-deductions-component-template:uuid@3.4.0:uuid@7.0.2:uuid@7.0.2')).toBe(true);
       });
    ...
    describe('fromString', () => {
       it('should convert the update string to an object', () => {
           expect(fromString('/Users/someone/git/prm-deductions-component-template:uuid@3.4.0:uuid@7.0.2:uuid@7.0.2')).toEqual({
               package: 'uuid',
